...
export const AddOn = () => {
  ...
  const { isYearlyActive, toggleAddOn, selectedAddOns, setSelectedAddOns } = useContext(PricingContext);
  ...
  const handleCheckboxChange = (addOnType) => {
    ...
    if (addOnType === "online") {
      ...
      if (!isOnlineActive) {
        setSelectedAddOns((prev) => [...prev, "online"]);
      } else {
        setSelectedAddOns((prev) => prev.filter((addOn) => addOn !== "online"));
      }
    ...
    if (addOnType === "larger") {
      setIsOnlineActive(!isOnlineActive);
      if (!isOnlineActive) {
        setSelectedAddOns((prev) => [...prev, "larger"]);
      } else {
        setSelectedAddOns((prev) => prev.filter((addOn) => addOn !== "larger"));
      }
    ...
    if (addOnType === "customize") {
      setIsOnlineActive(!isOnlineActive);
      if (!isOnlineActive) {
        setSelectedAddOns((prev) => [...prev, "customize"]);
      } else {
        setSelectedAddOns((prev) => prev.filter((addOn) => addOn !== "customize"));
      }
...
//     if (addOnType === "online") {
//       setIsOnlineActive(!isOnlineActive);
//       setIsNowChecked(!isOnlineActive);
