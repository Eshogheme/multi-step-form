    ...
    const handleToggle = (refName) => {
        ...
        if (refName === "Arcade") {
            if (arcadeRef.current) {
                isYearlyActive ? console.log(yearlyRef.current.textContent): console.log(arcadeMonthlyRef.current.textContent);
            ...
            if (advancedRef.current) {
                isYearlyActive ? console.log(yearlyAdvancedRef.current.textContent): console.log(arcadeMonthlyRef.current.textContent);
            ...
            if (proRef.current) {
               isYearlyActive ?  console.log(yearlyProRef.current.textContent) : console.log(proMonthlyRef.current.textContent);
